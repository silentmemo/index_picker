...
def main():
    ...
    if best_index_I7_I5 in chosen_I7_I5_list:
        ...
        new_I7_sequence = ava_df[ava_df["index_name"] == new_I7_name]["sequence"].to_string(index = False)
        new_I5_sequence = ava_df[ava_df["index_name"] == new_I5_name]["sequence"].to_string(index = False)
        print(chosen_index_dict)
        ### construct new dict ### problem is the weight, need to update it here TODO 
        ### TODO append the best_index_I7_I5, ask if pick another one
